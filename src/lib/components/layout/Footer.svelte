	...
	<nav>
		<div class="grid grid-flow-col gap-4">
			...
			<a href="https://codeberg.org/gnoblet" class="btn btn-ghost btn-square btn-lg" aria-label="Codeberg">
				...
				>
					<path
						d="M11.955.49A12 12 0 0 0 0 12.49a12 12 0 0 0 1.832 6.373L11.838 5.928a.187.14 0 0 1 .324 0l10.006 12.935A12 12 0 0 0 24 12.49a12 12 0 0 0-12-12 12 12 0 0 0-.045 0zm.375 6.467l4.416 16.553a12 12 0 0 0 5.436-4.119z"
					></path>
				</svg>
			</a>
